...
import static com.app85taxi.passenger.R.id.ratingBar;
...
public class HistoryDetailActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void setData() {
        ...
        Utils.printLog("tSaddressdetails", generalFunc.getJsonValue("tSaddress", tripData));
...
//                        bn.putString("UserProfileJson", getIntent().getStringExtra("UserProfileJson"));
//                        new StartActProcess(getActContext()).startActWithData(HistoryActivity.class, bn);
//                        finish();
                        //LBL_SUCCESS_RATING_SUBMIT_TXT
