...
public class CommonUtilities {
    ...
    public static final String package_name = "com.app85taxi.passenger";
    ...
    //  public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice27072017.php?";

    //public static final String SERVER_URL = "http://nexfret.com/";
    public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice.php?";
    // public static final String SERVER_URL = "http://mobileappsdemo.com/projects/nexfretmoto/";
    //public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice_ufx_email.php";
    // public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice_ufx.php?";
    //public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice_ufxgb.php?";
    //public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice_ufx12052017.php?";
    //public static final String SERVER_URL_WEBSERVICE = SERVER_URL + "webservice_ufx13052017.php?";
